...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.student_pages.manage', compact('readStudent'));
    }
    ...
    {
        return view('frontend.student_pages.create');
    }
    ...
    public function managetrash()
    {
        ...
        return view('frontend.student_pages.trash_manage', compact('trashStudent'));
    }
